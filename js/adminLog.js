...
$(document).ready(function(){
    ...
    $("#LogList").on("click","a.CHKList",function(){
        ...
        var b=a.substr(2)
        var c=b.split("_");
        $.post("../control/LogApi.php",{"act":2,"id":c[0],"sqldb":c[1]},function(res){
    ...
    $("#showTip3Head").click(function(){
     ...
     $("#addKey").on("change","#SelPro",function(){
          ...
          if(a=="all"){
              ...
              $.post("../control/LogApi.php",{"act":3,"product":a},function(res){
    ...
    $("#addKey").on("click","#SUBBUT",function(){
        ...
        $.post("../control/LogApi.php",{"act":1,"product":a, "kind":b, "help":c, "startT":d, "stopT":e},function(res){
            if(res.code==10){
                alert(res.msg);
                return false;
            }
    ...
    $("#footer").on("click","a.ChangePape",function(){
        var a=this.id;
        $.post("../control/LogApi.php",{"act":4,"page":a},function(res){
            $("#LogList").html(res.data.list);
            $("#page").html("第 "+res.data.onList+" 页");
        },"json");
    });
...
function getHeaderContorl(){
    $.post("../control/LogApi.php",{"act":0},function(res){
